...
export const avatarSVG = (
  <svg
    ...
    className="h-9 w-9 stroke-current transition-colors ease-out hover:text-white"
  >
    <path
  ...
  return (
    <header className="flex items-center justify-between gap-2 bg-orangeLight px-5 py-2 font-medium md:px-[60px] md:py-4 lg:tracking-tight">
      ...
      {isTablet ? (
        ...
        <Link href="/auth/login">{avatarSVG}</Link>
      )}
    </header>
  );
};
