...
export default function NotFound() {
  return (
    <>
      <Header />
      <main className="flex items-center justify-center bg-radial from-orange-50/30 via-transparent to-transparent px-4 py-16 md:min-h-[75vh]">
        <div className="relative mx-auto flex w-full max-w-[550px] flex-col items-center rounded-3xl border border-neutral-100 bg-white p-8 text-center shadow-xl md:p-12">
          ...
          <p className="mb-8 max-w-md text-base leading-relaxed text-neutral-500">
            Можливо, адреса сторінки введена з помилкою, або цей товар тимчасово відсутній.
            Спробуйте розпочати з головної сторінки або перейдіть до каталогу товарів.
          </p>
