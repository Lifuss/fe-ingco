    ...
    <main className="min-h-[550px] w-full bg-white px-[60px] pt-8 pb-12">
      <section className="mb-10 flex flex-col gap-1">
        ...
        <div className="col-span-1">
          <h2 className="mb-5 text-center text-xl font-medium">Eксель таблиці (.xlsx)</h2>
          <div className="mb-8 grid grid-cols-2 gap-3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-center text-sm text-gray-500">Таблиця для імпорту на prom.ua</p>
