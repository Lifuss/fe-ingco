  ...
  return (
    ...
    >
      <div className="grow cursor-pointer" onClick={() => handleDirectToProduct(_id, slug)}>
        ...
        <h4 className={clsx('font-medium', name.length > 50 ? 'text-xs' : 'text-sm')}>{name}</h4>
      ...
      <div className="flex items-center justify-between">
        ...
        {listType === 'retail' ? (
            ...
            >
              {rrcSale ? (
                <div className="flex flex-col items-end">
                  <span className="text-xs line-through">{priceRetailRecommendation} грн</span>
                  <span className="text-orange-light pl-1">{rrcSale} грн</span>
                </div>
              ) : (
          ...
          <div className="mt-2 flex items-center justify-end">
            ...
            >
              <span>{price} $</span>
              {USDCurrency ? <span>{Math.ceil(price * USDCurrency)} грн</span> : null}
            </p>
            <button
