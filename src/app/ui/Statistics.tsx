...
const Statistics = () => {
  const [dateRange, setDateRange] = useState<[Date, Date]>([getLastWeekDate(), new Date()]);
  const [tempDateRange, setTempDateRange] = useState<[Date | undefined, Date | undefined]>([
    getLastWeekDate(),
    new Date(),
  ]);
      ...
      <div className="flex justify-end gap-3">
        <label className="flex items-center gap-2 text-xl">
          ...
          <DatePicker
            ...
            endDate={tempEndDate}
            onChange={(update) => setTempDateRange(update as [Date | undefined, Date | undefined])}
