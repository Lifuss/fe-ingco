...
export function CardSkeleton() {
  return (
    <div
      className={`relative flex h-[316px] w-full flex-col justify-between rounded-2xl border-2 border-transparent p-4 shadow-md transition-all duration-300 ease-in-out hover:scale-105 hover:border-brand-accent-yellow hover:shadow-lg`}
    >
