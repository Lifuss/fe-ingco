...
const UsersStats = () => {
  ...
  const { usersStats, userTableCheckboxesStatus } = useAppSelector((state) => state.dashboardSlice);
  ...
  const handleBoxClick = () => {
    dispatch(setCheckbox(CheckboxActionType.IsUserVerified));
  };
  ...
  return (
    <div
      ...
      className={clsx(
        ...
        usersStats.notVerified >= 1 && 'border-red-400 shadow-md shadow-red-700',
      )}
    >
