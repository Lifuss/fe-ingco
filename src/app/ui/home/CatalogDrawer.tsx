...
export default function CatalogDrawer({ isOpen, onClose }: CatalogDrawerProps) {
  ...
  return (
    <>
      ...
      <div
        className="fixed inset-0 top-[116px] z-40 bg-black/40 backdrop-blur-sm transition-opacity duration-300 animate-fade-in"
        onClick={onClose}
      />

      {/* Main Drawer Container */}
      <div
        className="absolute left-0 right-0 top-[116px] z-50 w-full border-b border-[#E5E3DD] bg-[#FFFDFB] shadow-xl animate-slide-down flex flex-col items-center select-none"
