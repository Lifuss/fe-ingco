    ...
    <section className="mb-10 px-5 md:px-[60px] 2xl:mb-20" id="aboutUs">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:gap-5 xl:gap-16">
        ...
        <div className="flex flex-col gap-2 text-sm lg:text-base xl:h-[524px] xl:justify-between xl:text-xl 2xl:text-2xl">
          <p>
            Ми є одним із найпопулярніших та надійних магазинів будівельних та домашніх інструментів
            у нашому регіоні. Наша компанія вже багато років забезпечує клієнтів найкращою якістю
            продукції та високим рівнем обслуговування. Ми офіційний імпортер продукції в Україні.
          </p>
          <p>
            У нашому асортименті ви знайдете широкий вибір інструментів для будівництва, ремонту та
            побутового використання. Від професійного обладнання для будівельних підприємств до
            зручних та надійних інструментів для домашнього майстра — у нас є все необхідне для
            ваших потреб.
          </p>
          ...
          <div className="flex justify-between">
            ...
            <div>
              ...
              <a
                ...
                className="hover:text-orange-light text-blue-400"
              >
