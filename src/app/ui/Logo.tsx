...
export default function Logo() {
  ...
  return (
    <div className="flex items-start gap-1 relative">
      ...
      {/* Ukraine Pill Badge */}
      <div className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-amber-400 text-[9px] font-bold text-neutral-900 border border-amber-500/10 shadow-sm select-none shrink-0 mt-0.5">
        <span>Україна</span>
