...
const ContactsClient = () => {
  ...
  return isDesktop ? (
    <section id="contacts" className="mx-auto w-[1280px] px-[30px] pt-20 pb-20">
      ...
      <ul className="bg-card-tint mx-auto mb-5 min-h-36 w-fit rounded-2xl p-4 text-xl text-blue-600 shadow">
        <li>
        ...
        <li>
          <Link className="hover:text-orange-light" href="tel:+380964123628">
            +380 96-41-23-628
          </Link>
        </li>
        <li>
          <Link href="mailto:ingco-service@ukr.net" className="hover:text-orange-light">
      ...
      <h2 className="mb-5 text-center text-3xl">Фізичні відділення для самовивозу</h2>
      <ul>
        <li className="mb-20 flex flex-col gap-5">
          <h3 className="text-center text-2xl font-medium">Вижницьке відділення</h3>
          <div className="flex justify-center gap-8">
            <div className="text-lg">
              <h4 className="font-medium">Адреса:</h4>
              <p className="mb-4 w-[260px]">м. Вижниця, Чернівецька обл. Вул. Українська 100/2</p>
        ...
        <li className="flex flex-col gap-5">
          <h3 className="text-center text-2xl font-medium">Герцаївське відділення</h3>
          <div className="flex justify-center gap-8">
            <div className="text-lg">
              <h4 className="font-medium">Адреса:</h4>
              <p className="mb-4 w-[250px]">м. Герца, Чернівецька обл. Вул. Штефана Великого 12</p>
              <h4 className="font-medium">Графік роботи:</h4>
              <p>Пн - Пт : 08:00-18:00</p>
              <p className="mb-4">Cб - Нд : 09:00-15:00</p>
            </div>
    ...
    <section id="contacts" className="container mx-auto mt-5 px-5 pb-5">
      ...
      <ul>
        <li className="mb-5 flex flex-col gap-5">
          <h3 className="text-center text-lg font-medium">Вижницьке відділення</h3>
          <iframe
          ...
          <div className="flex flex-wrap gap-16 gap-y-2">
            <div className="text-sm">
              <h4 className="text-base font-medium">Адреса:</h4>
              <p className="mb-4 w-[150px]">м. Вижниця, Чернівецька обл. Вул. Українська 100/2</p>
            </div>
            <div className="text-sm">
        ...
        <li className="flex flex-col gap-5">
          ...
          <div className="flex flex-wrap gap-16 gap-y-2">
            <div className="text-sm">
              <h4 className="text-base font-medium">Адреса:</h4>
              <p className="mb-4 w-[150px]">м. Герца, Чернівецька обл. Вул. Штефана Великого 12</p>
            </div>
            <div className="text-sm">
              <h4 className="text-base font-medium">Графік роботи:</h4>
              <p>Пн - Пт : 08:00-18:00</p>
