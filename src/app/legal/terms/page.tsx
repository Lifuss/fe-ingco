    ...
    <div className="container mx-auto max-w-4xl px-5 py-10">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4 text-lg leading-relaxed">
          Ці Умови використання (далі – «Умови») регулюють відносини між Адміністрацією та
          користувачами інтернет-магазину{' '}
        ...
        <p className="mb-4 text-lg leading-relaxed">
          Використовуючи Сайт, Ви приймаєте ці Умови та зобов&apos;язуєтеся їх дотримуватися. Якщо
          Ви не згодні з цими Умовами, будь ласка, не використовуйте Сайт.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4 text-lg leading-relaxed">
          Користувач має право використовувати Сайт виключно в законних цілях та відповідно до
          призначення Сайту.
        </p>
        <p className="mb-4 text-lg leading-relaxed">Забороняється:</p>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4 text-lg leading-relaxed">
          Весь контент Сайту, включаючи тексти, зображення, логотипи, дизайн, є власністю
          Адміністрації або її ліцензіарів і захищений законодавством про інтелектуальну власність.
        </p>
        <p className="mb-4 text-lg leading-relaxed">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4 text-lg leading-relaxed">
          Для оформлення замовлень та використання певних функцій Сайту користувач може створити
          обліковий запис.
        </p>
        <p className="mb-4 text-lg leading-relaxed">Користувач зобов&apos;язується:</p>
        <ul className="mb-4 list-disc space-y-2 pl-6 text-lg leading-relaxed">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4 text-lg leading-relaxed">
          Адміністрація намагається забезпечити точність інформації про товари, однак не гарантує
          повної відповідності описів та зображень реальним товарам.
        </p>
        <p className="mb-4 text-lg leading-relaxed">
          Адміністрація має право змінювати ціни, описи товарів та наявність товарів без
      ...
      <section className="mb-8">
        ...
        <p className="mb-4 text-lg leading-relaxed">Адміністрація не несе відповідальності за:</p>
        <ul className="mb-4 list-disc space-y-2 pl-6 text-lg leading-relaxed">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4 text-lg leading-relaxed">
          Сайт може містити посилання на сторонні веб-сайти. Адміністрація не несе відповідальності
          за контент, політику конфіденційності та практики сторонніх сайтів.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4 text-lg leading-relaxed">
          Адміністрація має право в будь-який час змінювати ці Умови. Нова редакція набуває чинності
          з моменту її розміщення на Сайті.
        </p>
        <p className="mb-4 text-lg leading-relaxed">
          Продовжуючи використовувати Сайт після внесення змін, Ви приймаєте нові Умови.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4 text-lg leading-relaxed">
          Адміністрація має право припинити або обмежити доступ користувача до Сайту у разі
          порушення цих Умов без попереднього повідомлення.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4 text-lg leading-relaxed">
          Ці Умови регулюються законодавством України. Усі спори підлягають вирішенню відповідно до
      ...
      <section className="mb-8">
        ...
        <p className="mb-4 text-lg leading-relaxed">З питань щодо цих Умов звертайтеся:</p>
        <p className="mb-4 text-lg leading-relaxed">
          Електронна адреса:{' '}
