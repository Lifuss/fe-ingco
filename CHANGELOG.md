...
- **Обробка переходу в адмінку з нотифікацією помилок**:
  ...
  - Додано безпечне відображення помилки через `react-toastify` (*«Не вдалося виконати перехід. Спробуйте оновити сторінку або увійти знову.»*) у разі недоступності чи невалідності сесії без розкриття захищених шляхів.
